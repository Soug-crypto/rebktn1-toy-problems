...
Tree.prototype.countLeaves = function(tree){
  var counter = 0;

  function traverse(TreeInstance){
    if (TreeInstance.children.length === 0) {
      counter++;
      return
    }

    for (var i = 0; i < TreeInstance.children.length; i++) {
      traverse(TreeInstance.children[i])
    }

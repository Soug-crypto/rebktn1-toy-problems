...
var shuffleDeck = (reps = 2000) => {
    ...
    for (var i = 0; i < reps; i++) {
      let randSuit =  Math.floor(Math.random() * Math.floor(suits.length));
      let randValue =  Math.floor(Math.random() * Math.floor(values.length));
      obj[suits[randSuit] + values[randValue]] = 0
